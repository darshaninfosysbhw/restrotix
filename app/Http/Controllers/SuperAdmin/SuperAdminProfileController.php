...
class SuperAdminProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if ($changes !== []) {
            $this->logActivity(
                request: $request,
                event: 'superadmin.profile.updated',
                description: 'Super admin profile details updated.',
                meta: ['changes' => $changes]
            );
        }

        return redirect()->route('superadmin.profile')->with('toast', [
            [
                'type' => 'success',
    ...
    public function updatePassword(Request $request)
    {
        ...
        $this->logActivity(
            request: $request,
            event: 'superadmin.profile.password_changed',
    ...
    {
        return [
            // Future-safe aliases: full_name -> name, phone -> phone_number
    ...
    {
        return [
            // Future-safe aliases: new_password fields
